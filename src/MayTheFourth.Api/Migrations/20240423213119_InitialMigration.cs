        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OpeningCrawl = table.Column<string>(type: "NVARCHAR(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gravity = table.Column<string>(type: "NVARCHAR(10)", maxLength: 10, nullable: false),
                    ...
                    Terrain = table.Column<string>(type: "NVARCHAR(30)", maxLength: 30, nullable: false),
                    SurfaceWater = table.Column<string>(type: "NVARCHAR(20)", maxLength: 20, nullable: false),
                    Url = table.Column<string>(type: "NVARCHAR(255)", maxLength: 255, nullable: false),
                    Created = table.Column<DateTime>(type: "DATETIME", nullable: false),
                    Edited = table.Column<DateTime>(type: "DATETIME", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EyeColor = table.Column<string>(type: "NVARCHAR(10)", maxLength: 10, nullable: false),
